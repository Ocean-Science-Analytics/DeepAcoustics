...
ClusteringData.OptUsed = repmat('0',size(ClusteringData,1),1);
...
if tf == 1
    switch optimize
        ...
        case 1
            ...
            ClusteringData.OptUsed = repmat('1',size(ClusteringData,1),1);
        ...
        case 2
            ...
            ClusteringData.OptUsed = repmat('1b',size(ClusteringData,1),1);
        ...
        case 3
            ...
            ClusteringData.OptUsed = repmat('3',size(ClusteringData,1),1);
        ...
        case 4
            ...
            ClusteringData.OptUsed = repmat('4',size(ClusteringData,1),1);
    end
else
