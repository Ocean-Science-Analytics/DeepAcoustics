...
% Modified work Copyright (c) 2022 Peter Sugarman, Elizabeth Ferguson,    %
% Jennifer Pettis Schallert, & Gabriela Alongi                            %
%                                                                         %
...
function varargout = DeepWaves(varargin)

set(groot,'defaultFigureVisible','on');
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @DeepWaves_OpeningFcn, ...
    'gui_OutputFcn',  @DeepWaves_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before DeepWaves is made visible.
function DeepWaves_OpeningFcn(hObject, eventdata, handles, varargin)
...
fprintf(1,'%s %s\n\n', 'DeepWaves version', handles.DSVersion);
...
function varargout = DeepWaves_OutputFcn(hObject, eventdata, handles)
shg;
...
% --------------------------------------------------------------------
function AboutDeepWaves_Callback(hObject, eventdata, handles)
title = 'About DeepWaves';
...
A = zeros(128);
A = insertText(A,[64,20],'Coffey & Marx & Ciszek, 2021','TextColor','white','BoxColor','Black','AnchorPoint','Center','FontSize',11);
A = insertText(A,[64,64],'DeepWaves','TextColor','white','BoxColor','Black','AnchorPoint','Center');
