classdef RecordOptsDlg_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.dlgRecordOpts.Position = [100 100 641 716];
            ...
            app.buttonOK.Position = [269 29 109 42];
            ...
            app.NetworkSettingsPanel.Position = [14 96 613 298];
            ...
            app.checkboxLoadNet.Position = [239 405 177 22];
            ...
            app.editfieldSR.Position = [263 503 100 22];
            ...
            app.editfieldRecLgth.Editable = 'off';
            app.editfieldRecLgth.Enable = 'off';
            app.editfieldRecLgth.Position = [396 543 100 22];
            ...
            app.checkboxCont.Position = [151 543 83 22];
            ...
            app.RecordingLengthsecEditFieldLabel.Position = [251 543 130 22];
            ...
            app.SampleRateHzEditFieldLabel.Position = [148 503 100 22];
            ...
            app.AudioFilenameEditFieldLabel.Position = [149 463 88 22];
            ...
            app.buttonBrowse.Position = [527 610 81 22];
            ...
            app.SaveLocationTextAreaLabel.Position = [38 610 85 22];
